...
Once a model is calibrated you can use these parameters in a simulation, or when other known parameters are provided to you use those. Parameters are returned by the calibration routine as a nested list and should be provided as such to the prediction function `hr_predict()`.
